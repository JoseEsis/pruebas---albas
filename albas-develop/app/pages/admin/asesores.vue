<template>
    <div class="p-6">
        ...
        <div
            v-if="showCreateForm"
            class="bg-white rounded-lg text-black shadow-md p-6 mb-6"
        >
            <h2 class="text-xl font-semibold text-gray-800 mb-4">
                Crear Nuevo Asesor
            </h2>
            <form
                @submit.prevent="crearAsesor"
            ...
            <div
                v-if="mensajeCreacion"
                :class="mensajeCreacion.tipo"
...
const crearAsesor = async () => {
    ...
    try {
        ...
        mensajeCreacion.value = {
            ...
            texto:
                error.data?.message || error.message || "Error al crear asesor",
        };
    } finally {
